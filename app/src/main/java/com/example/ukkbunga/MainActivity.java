...
public class MainActivity extends AppCompatActivity {
    ...
    private void viewSetup(){
        ...
        b_equal = findViewById(R.id.hasil_button);
        ...
        b_dot = findViewById(R.id.koma_button);
        b_para1 = findViewById(R.id.persen_button);
        b_para2 = findViewById(R.id.plusmin_button);
